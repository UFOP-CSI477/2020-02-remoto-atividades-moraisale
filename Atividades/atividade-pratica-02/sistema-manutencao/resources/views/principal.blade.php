...
<body class="bg-light py-0 px-0">
  ...
  <!-- <div id="info" style="text-align: center;">
    <h1>Sistema de Agendamento de Manutenções</h1>
    <h3>Área de suporte para relatório de equipamentos e manutenções cadastradas</h3>
    <h3>Área administrativa para cadastro e alterações de manutenções e equipamentos</h3>
  </div> -->
